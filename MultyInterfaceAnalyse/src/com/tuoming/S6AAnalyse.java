...
import com.tuoming.entity.s6a.S6aDecode;
...
public class S6AAnalyse {
    ...
    public static void main(String args[]) {
        ...
        //输入参数检查
        if (args.length < 11) {
            System.out.println("【Class    】:" + S6AAnalyse.class.getName());
        ...
        ReadFile readFile = new S6aReadFile();
        ...
        while (true) {
            ...
            while ((sort = readFile.list.getFirst()) != null) {
                ...
                CommonDecode line = new S6aDecode();
                line.decode(split);
                WriteUntil.dealData(line, publicTableMap, cycleTime, writeMap, outputPath, fileSize, WriteIndex.s6aWrite);
            }
