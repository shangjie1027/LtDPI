...
import com.tuoming.readfile.OtherReadFile;
...
public class OtherAnalyse {
    ...
    public static void main(String args[]) {
        ...
        //输入参数检查
        if (args.length < 11) {
            System.out.println("【Class    】:" + OtherAnalyse.class.getName());
        ...
        ReadFile readFile = new OtherReadFile();
        ...
        while (true) {
            ...
            while ((sort = readFile.list.getFirst()) != null) {
                sortOutTimeCount = 0;
                String[] split = sort.str.split(OtherIndex.splite, -1);
                CommonDecode line = new OtherDecode();
                line.decode(split);
                WriteUntil.dealData(line, publicTableMap, cycleTime, writeMap, outputPath, fileSize, WriteIndex.otherWrite);
            }
