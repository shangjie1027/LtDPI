package com.tuoming.entity.s1uhttps;
...
public interface S1uhttpsIndex {
	...
	int ulDURARION_Index=92;//上行持续时长
	int dlDURARION_Index=93;//下行持续时长
	...
	int contentTYPE_Index=25;//Content-Type
	int portUSER_Index=29;//源端口
	int portSERV_Index=33;//目的端口
	int host_Index=91;//HOST
	...
	int rttUL_Index=58;//RTT上行总时延
	int rttULNUM_Index=57;//RTT上行次数
	int rttDL_Index=60;//RTT下行总时延
	int rttDLNUM_Index=59;//RTT下行次数
	int l7UPTRANSTIME_Index=0000;//上行应用传输有效时长
	int l7UPTRAFFIC_Index=0000;//上行应用传输有效流量
	int l7DOWNTRANSTIME_Index=0000;//下行应用传输有效时长
