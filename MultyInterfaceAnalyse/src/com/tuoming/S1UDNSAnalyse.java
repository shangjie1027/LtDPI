...
import com.tuoming.entity.s1udns.S1udnsDecode;
...
public class S1UDNSAnalyse {
    ...
    public static void main(String args[]) throws IOException {
        ...
        //输入参数检查
        if (args.length < 11) {
            System.out.println("【Class    】:" + S1UDNSAnalyse.class.getName());
        ...
        ReadFile readFile = new S1udnsReadFile();
        ...
        while (true) {
            ...
            while ((sort = readFile.list.getFirst()) != null) {
                sortOutTimeCount = 0;
                String[] split = sort.str.split(S6aIndex.splite, -1);
                CommonDecode line = new S1udnsDecode();
                line.decode(split);
                WriteUntil.dealData(line, publicTableMap, cycleTime, writeMap, outputPath, fileSize, WriteIndex.s1udnsWrite);
            }
