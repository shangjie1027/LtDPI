...
public class S1uhttpDecode extends CommonDecode implements Serializable {
    ...
    public void getMENTHOD(String[] str, int menthod_Index) {
        this.menthod = typeDecode.MENTHOD(str[menthod_Index]);
    }
    ...
    public void getMCC(String[] str, int mcc_Index) {
        ...
        if (str[mcc_Index].equals("65535")) this.mcc = "460";
    }
    ...
    public void getHTTPVERS(String[] str, int httpVERS_Index) {
        if (str[httpVERS_Index].equals("4")) this.httpVERS = "2";
        else this.httpVERS = "1";
    }
    ...
    public void getWEBAPP(String[] str, int webAPP_Index) {
        if (!str[webAPP_Index].equals("0")) this.webAPP = "1";
        else this.webAPP = "2";
    }
    ...
    public void getSGWGGSNIPAdd(String[] str, int sgwGGSNIPAdd_Index) {
        ...
        super.machineIP = str[sgwGGSNIPAdd_Index];
    }
