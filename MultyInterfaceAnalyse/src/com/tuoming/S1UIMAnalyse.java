...
import com.tuoming.entity.s1uim.S1uimDecode;
import com.tuoming.readfile.ReadFile;
import com.tuoming.readfile.S1uimReadFile;
...
public class S1UIMAnalyse {
    ...
    public static void main(String args[]) throws IOException {
        ...
        //输入参数检查
        if(args.length <11){
            System.out.println("【Class    】:" + S1UIMAnalyse.class.getName());
        ...
        ReadFile readFile = new S1uimReadFile();
        //写文件Map网元->SgsWrite
        //每个网元对应一个写通道
        ...
        while (true){
            ...
            while ((sort = readFile.list.getFirst()) != null) {
                ...
                else if((sort.time - fiveminutes) > 300000000)
                {
                ...
                listsplise.add(sort.str.split(S1uimDecode.splite, -1));
                sortOutTimeCount = 0;
            }
    ...
    {
        S1uimDecode line = new S1uimDecode();
